          ...
          builder: (context, child) {
            return Transform.scale(
              ...
              child: SizedBox(
                ...
                height: widget.size,
                child: CustomPaint(
                  painter: _AzileLogoPainter(color: color),
                ),
              ),
            );
          },
...
class _AzileLogoPainter extends CustomPainter {
  final Color color;

  const _AzileLogoPainter({required this.color});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Node positions â€” hexagonal graph
    final nodes = <Offset>[
  ...
  @override
  bool shouldRepaint(_AzileLogoPainter oldDelegate) =>
