...
impl EntityRepository {
    ...
    pub async fn fetch_entities_batch(
        ...
        // ── 1. Fetch all entity rows in one round-trip ────────────────────────
        ...
        // ── 2. Fetch all attributes for those entities in one round-trip ──────
        ...
        // ── 3. Group attributes by entity_id ──────────────────────────────────
        ...
        // ── 4. Assemble CanonicalEntity for each entity row ───────────────────
