...
impl EnrichmentService {
    ...
    pub async fn list_providers(&self) -> Result<Vec<EnrichmentProvider>, StatusCode> {
        sqlx::query_as::<_, EnrichmentProvider>(
            "SELECT provider_code, display_name, category, description, logo_url,
    ...
    pub async fn list_configs(&self, tenant_id: Uuid) -> Result<Vec<TenantEnrichmentConfig>, StatusCode> {
        sqlx::query_as::<_, TenantEnrichmentConfig>(
            "SELECT enrichment_config_id, tenant_id, provider_code, is_enabled,
    ...
    pub async fn upsert_config(
        ...
        sqlx::query_as::<_, TenantEnrichmentConfig>(
            "INSERT INTO core_mdm.tenant_enrichment_configs
    ...
    pub async fn list_requests(
        ...
        sqlx::query_as::<_, EnrichmentRequest>(
            "SELECT request_id, tenant_id, entity_id, provider_code, status,
    ...
    pub async fn trigger_enrichment(
        ...
        sqlx::query_as::<_, EnrichmentRequest>(
            "INSERT INTO core_mdm.enrichment_requests
