...
use dashmap::DashMap;
use nexus_redis::{RedisRateLimiter, SessionStore, TokenBlocklist};
use uuid::Uuid;
...
pub struct AppState {
    ...
    /// In-process license cache — keyed by tenant UUID, entries expire after 5 minutes.
    ...
    /// JWT revocation blocklist — stores JTIs of logged-out tokens until expiry.
