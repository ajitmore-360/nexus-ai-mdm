-- ============================================================================
-- 0012 — Submaster (Reference Data) Tables
--
...
-- ── Seed: common submasters for the demo tenant (no-op if tenant absent) ─────
DO $$
DECLARE
...
IF NOT EXISTS (SELECT 1 FROM core_mdm.tenants WHERE tenant_id = demo_tid) THEN
    RETURN;
END IF;
